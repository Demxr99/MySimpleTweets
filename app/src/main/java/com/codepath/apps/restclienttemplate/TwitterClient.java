...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "ZC89MG5I94sGr3doRlUnaTniu";
	public static final String REST_CONSUMER_SECRET = "AZCrxQtmIwOxybLkapox8vVQ96fbqATMKAiL2a9lLRxUr6yc0D";
	...
	public void sendTweetReply(String message, long id, AsyncHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/update.json");
		RequestParams params = new RequestParams();
		params.put("status", message);
	...
	public void undoRetweet(long id, AsyncHttpResponseHandler handler){
